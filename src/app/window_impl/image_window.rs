...
pub struct ImageSelectorWindowImpl {
    pub region_selector: RegionSelector,
    win_inst: WindowInstance,
    window_id: Target,
}

impl ImageSelectorWindowImpl {
    pub fn new(
        win_inst: WindowInstance
    ) -> Self {

        ImageSelectorWindowImpl {
            window_id:Target::Window(AppWindow::RegionSelectorCanvasWindow),
...
impl EventListener for ImageSelectorWindowImpl {
